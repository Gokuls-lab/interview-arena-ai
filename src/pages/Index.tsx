...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-indigo-600 to-blue-500 py-16 md:py-24 text-white">
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-8 mb-10 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {currentUser ? (
                <Link to="/dashboard">
                  <Button size="lg" className="bg-white text-indigo-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="lg:w-1/2">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-indigo-600 rounded-lg p-4 shadow-lg">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow hover:border-indigo-200 group">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Connect & Apply</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Interview & Feedback</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">What People Say</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all hover:-translate-y-1">
