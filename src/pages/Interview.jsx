  ...
  useEffect(() => {
    const loadInterviewData = async () => {
      ...
      try {
        ...
        // In a real app, you would fetch the specific interview
        // For demo, we'll assume the first interview for this job
  ...
  const processResponse = async (userInput) => {
    try {
      ...
      if (shouldEnd) {
        ...
        const session = aiInterviewService.startSession('software-developer');
